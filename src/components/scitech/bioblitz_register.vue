...
<div :class = "`title-flex`">
		...
		<div :class = "`content`">
			<div data-tf-widget="wvdxPlK8" data-tf-opacity="100" data-tf-iframe-props="title=Bioblitz" data-tf-transitive-search-params data-tf-medium="snippet" style="width:100%;height:100%;"></div>
		</div>
	</div>
</template>
